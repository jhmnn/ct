...
g++ $LDFLAGS $CXXFLAGS src/semantic-analyzer.cpp src/parser-phase.cc src/utilities.cc src/stringtab.cc src/cool-tree.cc obj/cool-flex-lexer.cc obj/cool-bison-parser.cc -o bin/parser
